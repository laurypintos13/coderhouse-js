...
for(const prod of productosLista){    
    let contenedor = document.querySelector("#divlista");
...
//     let prodVendidos = document.querySelector(".productosVendidos");
//     prodVendidos.innerHTML = `<h3>Informacion de venta:</h3>
//                             <p> codigo: ${procesoPago.codigo} </p>
//                             <p> precio: ${procesoPago.precio}</p>
//                             <p> tipo pago: ${procesoPago.tipoPago}</p>`;
//     document.prodVendidos.appendChild();
// }
...
//             let baseDatos = document.querySelector(".basedatos");
...
//             baseDatos.appendChild();
//         } 
//     } else {
//         let noBaseDatos = document.querySelector(".nobaseDatos");
//         noBaseDatos.innerHTML= `<h3>Base de datos de productos vendidos</h3>
//                                 <p>fecha de venta: ${fecha}</p>
//                                 <p>Datos de venta no guardados</p>`;
//         noBaseDatos.appendChild();
//     }
